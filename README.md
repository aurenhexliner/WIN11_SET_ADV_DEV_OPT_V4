...
1. Run script from Windows Terminal or PowerShell as administrator. Check rights to execute script first (Windows Settings -> System -> Advanced -> Terminal -> Powershell) Enable option to run scripts without signing.
Open Windows Terminal as administrator and set execution policy to "Unrestricted" typing: "Set-ExecutionPolicy Unrestricted" Run script: "./WIN11_SET_ADV_DEV_OPT_NET_USB_PWR_V4b.ps1"
